...
{
    public partial class List_Inventory_Head_Properties_SChoose : Form
    {
        dataconnection dt_conn = new dataconnection();
        DataTable dt_table = new DataTable();
        public List_Inventory_Head_Properties_SChoose()
        {
            InitializeComponent();
        }
        ...
        private void List_Inventory_Head_Properties_SChoose_Load(object sender, EventArgs e)
        {
