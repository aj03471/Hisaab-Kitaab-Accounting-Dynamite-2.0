...
{
    public partial class List_Inventory_Head_Properties_PChoose : Form
    {
        dataconnection dt_conn = new dataconnection();
        DataTable dt_table = new DataTable();
        public List_Inventory_Head_Properties_PChoose()
        {
            InitializeComponent();
        }
        ...
        private void List_Inventory_Head_Properties_PChoose_Load(object sender, EventArgs e)
        {
